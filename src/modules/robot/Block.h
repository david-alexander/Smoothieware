...
class Block {
    public:
        ...
        uint32_t get_current_accel_event(uint32_t tick, int8_t direction) const;
        ...
        using tickinfo_t= struct {
            ...
            int32_t acceleration_rate; // 2.30 fixed point signed
            int32_t deceleration_rate; // 2.30 fixed point
